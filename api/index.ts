...
// Note: This database will be reset on every cold start.
// For production, use a hosted database like Neon (Postgres) or Turso (LibSQL).
const dbPath = process.env.NODE_ENV === 'production' ? '/tmp/auditchek.db' : 'auditchek.db';
